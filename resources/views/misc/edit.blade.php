...
<div class="row mt-50">
    <div class="col m12 card">
        ...
        <div class="row">
            <div class="col m12">
                {!! Form::open(['action' => ['MiscController@update', $misc->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                <div class="row">
                    <div class="col m6 offset-m3 center-align">
                        <div class="current-profile-label left">Current Misc. Image</div>
                        <img class="responsive-img" src="/storage/misc_images/{{ $misc->image }}" alt="">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="input-field col m6 offset-m3">
                        {{ Form::text('title', $misc->title, ['class' => ''.($errors->has('title') ? 'invalid':'')]) }}
                    ...
                    <div class="row">
                        <div class="input-field col m6 offset-m3">
                            {{ Form::text('artist', $misc->artist, ['class' => ''.($errors->has('artist') ? 'invalid':'')]) }}
                    ...
                    <div class="row">
                        <div class="input-field col m6 offset-m3">
                            {{ Form::text('year', $misc->year, ['class' => ''.($errors->has('year') ? 'invalid':'')]) }}
                    ...
                    <div class="row">
                        <div class="input-field col m6 offset-m3">
                            {{ Form::text('location', $misc->location, ['class' => ''.($errors->has('location') ? 'invalid':'')]) }}
